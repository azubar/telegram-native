...
Cross platform native API [add-in](https://1c-dn.com/library/add_in_creation_technology/) bindings for [TDLib](https://github.com/tdlib/td) (Telegram Database library, version `1.8.65`) that allows to create full featured telegram clients within 1C:Enterprise platform.
...
## Rust Transition
A plan to transition this C++ component to a Rust-based Native API component using the `native_api_1c` template is available in the [Rust Transition Plan](docs/rust_transition_plan.md).
